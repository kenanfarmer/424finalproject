...
\begin{tabular}{|c||c|c|c|c|c|}
	\hline
	Log loss       &  MNB    & LogReg  & with SGD& RandForest & Mean \\
	\hline
...
\begin{tabular}{|c||c|c|c|c|c|}
	...
	\hline
	mean      & 0.8325 & 0.7822 & 0.7536 & 0.7677 & 0.3777 \\
	lrbow     & 0.8037 & 0.7353 & 0.7264 & 0.7311 & 0.4087 \\
	rfwc      & 0.8103 & 0.7559 & 0.7136 & 0.7342 & 0.4063 \\
...
Ensemble methods we 
this was the most sucesfull Random forest of trees
also tried 3 different types
 - builtint RandoForest and Boosting very scucesful
 0 average together multiple different methods (soft voting) =-  unsuccesful there was one defined victor that was way better
 - 3rd averaged on different sets of features and differing methods
